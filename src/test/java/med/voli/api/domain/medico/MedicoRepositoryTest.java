...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var medico = cadastrarMedico("Medico", "medico@voli.med", "123456", Especialidade.CARDIOLOGIA);
    ...
    @Test
    @DisplayName("Deveria devolver null quando unico médico cadastrado e de outra especialidade")
    void escolherMedicoAleatorioLivreNaDataCenario3() {
        var proximaSegundaAs10 = LocalDateTime.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .toLocalDate().atTime(10,0);

        cadastrarMedico("Medico", "medico@voli.med", "123456", Especialidade.DERMATOLOGIA);
